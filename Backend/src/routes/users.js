...
import { getUsers, getUser, deleteUser, updateUser, updateImage, getActiveUsers } from "../controllers/users.controllers.js"

const router = Router()

router.get("/", sessionValidation, roleValidation(["ADMIN_ROLE"]), getUsers)
router.get("/:id", sessionValidation, ownerValidation, getUser)
router.get("/active", sessionValidation, roleValidation(["ADMIN_ROLE"]), getActiveUsers)
